    ...
    <div class="w-4/5 h-full rounded-2xl flex flex-col pr-12 space-y-2">
      ...
      <div class="w-full flex h-5/6 bg-white shadow-md rounded-2xl">
        <div class="w-full flex flex-col justify-center items-center space-y-10">
          <h1 class="text-4xl font-extrabold ann-title text-custom-black">Match Password</h1>
          <div class="w-1/3 flex flex-col space-y-10">
            ...
            <div class="w-full flex items-center justify-center">
              <button @click="check()"
                class="w-full font-bold text-center text-white text-lg py-6 rounded-2xl border border-dashed border-indigo-500 bg-custom-blue">
                <span
                  class="">
                  Match
                </span>
        ...
        <!-- <div class="w-full h-full flex justify-center items-center">
          <div class="w-3/5 h-5/6 bg-white rounded-2xl">
