...
<div class="w-full h-full border flex justify-center items-center">
    ...
    <svg aria-hidden="true" class="inline w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-custom-blue" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
